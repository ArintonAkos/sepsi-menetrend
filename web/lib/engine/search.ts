...
export type PlaceKind = "stop" | "street" | "shop" | "poi" | "place" | "address" | "bikeStation" | "ticketPoint";
...
const KIND_BIAS: Record<PlaceKind, number> = {
  stop: -0.6, bikeStation: -0.35, ticketPoint: -0.35, place: -0.2, shop: 0, poi: 0, address: 0.1, street: 0.35,
};
