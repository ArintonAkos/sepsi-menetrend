...
const hu = {
  ...
  ticketFinder: "Hol vegyek jegyet?", ticketFinderGo: "Legközelebbi",
  ticketFinderNote: "A kiindulóponthoz legközelebbi nyitott jegypénztárig tervez útvonalat. Előbb add meg, honnan indulsz.",
...
const ro: Strings = {
  ...
  ticketFinder: "De unde cumpăr bilet?", ticketFinderGo: "Cea mai apropiată",
  ticketFinderNote: "Planifică ruta către cea mai apropiată casă de bilete deschisă, de la punctul de plecare. Alege întâi de unde pleci.",
...
const en: Strings = {
  ...
  ticketFinder: "Where do I buy a ticket?", ticketFinderGo: "Nearest",
  ticketFinderNote: "Plans a route to the nearest open ticket point from your start. Set where you start from first.",
