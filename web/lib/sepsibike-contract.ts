/** Edge-safe station validation shared with the browser planner.
 *
 * Keep this module dependency-free: Netlify's local Deno runner can load it
 * directly, while the browser-facing module also imports the OSM routers.
 */
